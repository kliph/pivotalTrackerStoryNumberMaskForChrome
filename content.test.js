...
describe("appendStoryNumberWithStoryName_Blocked function", () => {
  test("unit test", () => {
    document.body.innerHTML =
...
describe("appendStoryNumberWithStoryName_MyWork function", () => {
  test("unit test happy path", () => {
    document.body.innerHTML =
  ...
  test("handles no stories or panel present", () => {
    document.body.innerHTML = "<div></div>";
    var updatedStoryName = "4387 - Chore 1";
...
describe("appendStoryNumberWithStoryName_Epic function", () => {
  test("unit test", () => {
    document.body.innerHTML =
...
describe("appendStoryNumberWithStoryName_Search_Label function", () => {
  test("unit test", () => {
    document.body.innerHTML =
